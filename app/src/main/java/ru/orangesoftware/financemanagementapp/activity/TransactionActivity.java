...
import ru.orangesoftware.financemanagementapp.utils.*;

import java.io.*;
import java.util.*;

import static ru.orangesoftware.financemanagementapp.activity.CategorySelector.SelectorType.TRANSACTION;
