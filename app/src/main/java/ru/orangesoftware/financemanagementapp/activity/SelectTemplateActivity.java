...
import ru.orangesoftware.financemanagementapp.adapter.TemplateListAdapter;
import ru.orangesoftware.financemanagementapp.filter.Criteria;
import ru.orangesoftware.financemanagementapp.widget.SearchFilterTextWatcherListener;

import static ru.orangesoftware.financemanagementapp.activity.MyEntityListActivity.FILTER_DELAY_MILLIS;
import static ru.orangesoftware.financemanagementapp.blotter.BlotterFilter.CATEGORY_NAME;
import static ru.orangesoftware.financemanagementapp.blotter.BlotterFilter.TEMPLATE_NAME;
import static ru.orangesoftware.financemanagementapp.filter.WhereFilter.Operation.LIKE;
